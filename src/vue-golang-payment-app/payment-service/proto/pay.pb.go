...
func (*PayRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_pay_bffe4da1ed183015, []int{0}
}
...
func (*PayResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_pay_bffe4da1ed183015, []int{1}
}
...
func init() { proto.RegisterFile("proto/pay.proto", fileDescriptor_pay_bffe4da1ed183015) }

var fileDescriptor_pay_bffe4da1ed183015 = []byte{
